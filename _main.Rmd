...
forbruke oksygen per tidsenhet [@HillLupton; @BassetHowley]. Innen
...
personer til stede i rommet for å redusere konfundering [@halperin].
...
fordelt på kjønn. Det typiske målefeilet (typical error, [@hopkins]) fra
